    ...
    return (
      <main className="min-h-screen bg-slate-50 px-6 py-10">
        <div className="mx-auto max-w-xl rounded-3xl border border-amber-200 bg-amber-50 p-8 shadow-sm">
          ...
          <h1 className="text-2xl font-black text-amber-950">Logowanie nie jest skonfigurowane dla tego wdrożenia</h1>
          <p className="mt-4 leading-7 text-amber-900">
            Środowisko Vercel Preview nie ma kompletu wymaganych zmiennych Clerk. Dodaj je w ustawieniach projektu Vercel dla środowiska Preview i uruchom ponowny deployment.
          </p>
