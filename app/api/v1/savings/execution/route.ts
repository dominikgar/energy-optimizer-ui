...
import { resolveExecutionEnergy } from '../../../../../../lib/deviceExecutionEnergy';
import {
  createRequestId,
  recordAppEvent,
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (action === 'start') return startExecution(request, auth.userId, body, requestId);
    if (action === 'stop') return stopExecution(request, auth.userId, body, requestId);
